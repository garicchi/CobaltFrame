...
namespace CobaltFrame.Physics
{
    public class PhysicsCamera2D
    {
        ...
        public PhysicsCamera2D(GraphicsDevice graphics)
        {
            _graphics = graphics;
        ...
        public void Update(TimeSpan elapsedGameTime)
        {
            ...
            _currentPosition += 100f * delta * inertia * (float)elapsedGameTime.TotalSeconds;
            _currentRotation += 80f * rotDelta * rotInertia * (float)elapsedGameTime.TotalSeconds;
